...
const MobileNav = ({ onOpen, ...rest }: MobileProps) => {
   ...
   const navigate = useNavigate();
   const { data, isLoading, error, fetchData } = useApiRequest("POST",logoutEndPoint);
  ...
  const loggedInUserView = <> <IconButton
  size="lg"
  variant="ghost"
...
const signInView = <>
  <Stack
          ...
          direction={'row'}
          spacing={6}>
          <Button as={'a'} fontSize={'sm'} fontWeight={400} variant={'link'} onClick={()=>navigate("/login")} cursor="pointer">
            Sign In
          </Button>
          <Button
            as={'a'}
  ...
  return (
    <Flex
      ...
      <Button onClick={toggleColorMode}>
              ...
              {token===undefined || token===null ? signInView : loggedInUserView}
